...
class Spectrum_FFT:
    ...
    def __init__(self, file_path: str = None, line_sep='\t', spectrum: np.ndarray = None, show:bool = False):
        ...
        self.data_deleted_per_step_threshold = 1000
...
if __name__ == '__main__':
    ...
    spectrum = Spectrum_FFT('./data/spec.txt', show=True)
...
# spectrum = generate_gussian_spectrum(3, 800)
# np.savetxt('D:\space\work\spectrum_tools\data\gussian_spectrum_3fs_800nm.txt', spectrum, delimiter='\t')